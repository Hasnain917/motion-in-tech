...
export function PageHero({
  ...
  return (
    <section ref={root} className="relative overflow-hidden bg-background pb-20 pt-44 md:pb-32 md:pt-56">
      ...
      <div className="relative mx-auto w-full max-w-[1500px] px-6 md:px-10">
        ...
        <h1 className="font-display text-6xl font-bold leading-[0.9] tracking-tighter md:text-[10vw]">
          {title.split(" ").map((w, i) => (
          ...
          {accent && (
            <span className="mr-4 inline-block overflow-hidden align-bottom">
              <span
                data-ph-word
        ...
        {subtitle && (
          <p data-ph-meta className="mt-8 max-w-2xl text-lg text-muted-foreground md:text-xl">
            {subtitle}
          </p>
        )}
      </div>
